        ...
        <div className={`burger ${menuState ? 'open' : 'close'}`} onClick={() => {
            ...
            <div className={'burger-ring'}>
                <svg className={'svg-ring'}>
                    <path className="path" fill="none" stroke="#000" strokeMiterlimit="10" strokeWidth="4"
                          d="M 34 2 C 16.3 2 2 16.3 2 34 s 14.3 32 32 32 s 32 -14.3 32 -32 S 51.7 2 34 2"/>
                </svg>
            </div>
            <div>
                <svg className={'mask'}>
                    <path xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000" strokeMiterlimit="10"
                          strokeWidth="4"
